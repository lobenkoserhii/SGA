...
export const teamMembers = [
  {
    ...
    image: 'team_1.jpg',
    socials: [
      { name: 'Facebook', url: 'https://www.facebook.com', icon: 'Fb.svg' },
      { name: 'Instagram', url: 'https://www.instagram.com', icon: 'Insta.svg' },
...
export const permanentResidencyTypes = [
  {
    title: "Express Entry",
    details: {
      ...
      SelectionCriteria: "Express Entry candidates are assessed based on the Comprehensive Ranking System (CRS), which considers factors like age, education, work experience, language proficiency, and job offers."
    }
  },
  {
    ...
    details: {
      ...
      SelectionCriteria: "Eligibility and criteria vary depending on the province or territory. Applicants must express their interest, be nominated, and then apply for permanent residency to the federal government."
    }
  },
  {
  ...
  },
  {
    ...
    details: {
      ...
      SelectionCriteria: "Applicants need a valid job offer and an endorsement from a designated employer in one of the participating provinces."
    }
  },
  {
  ...
  {
    title: "Refugees and Protected Persons",
    details: {
...
export const citizenshipTypes = [
  {
    ...
    details: {
      Purpose: "Provincial Nominee Programs are designed to address each province or territory's unique labor market and economic requirements. They allow these regions to nominate individuals who possess the skills, work experience, or attributes that align with their specific needs.",
      ...
      QuotasAndAllocations: "Each province or territory has an allocation of nominations it can make based on its specific agreements with the federal government. These allocations may change annually based on regional needs and priorities.",
      Benefits: "PNP nominees enjoy a faster processing time for their permanent residency applications compared to other immigration streams. They also have the advantage of being selected based on their compatibility with the local job market and needs.",
      ProvincialAutonomy: "Each province or territory has the autonomy to create and manage its PNP streams, meaning that the programs can vary significantly from one region to another.",
      SupportingRegionalEconomies: "PNPs play a crucial role in supporting regional economies by attracting skilled workers, entrepreneurs, and investors who contribute to the economic growth and development of their respective provinces and territories.",
