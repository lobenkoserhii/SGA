...
function AboutUs() {
  return (
    <>
      <Head>
        <title>About Us – SGA Immigration</title>
        <meta name="description" content="Learn more about Spartak Gabroshvili and the SGA Immigration & Legal Services team." />
      </Head>
                ...
                <FadeInSection>
                  <div className='flex flex-col items-start gap-5'>
                    ...
                    <p className='text-WH text-xl font-normal font-outfit'>
                      ...
                      With over five years of dedicated practice in immigration law, Spartak specializes in managing intricate immigration matters
                      specifically focusing on Humanitarian and Compassionate (H&C) grounds cases.
                      In addition to his private practice, Spartak has served as a Program Integrity Specialist with the Ontario Government, bringing
                      a deep understanding of compliance, policy enforcement, and the integrity of immigration programs to his work.
                      Spartak holds a Master of Law from the Yaroslav Mudryi National Law University in Ukraine and is currently pursuing a PhD in
                      International Law and Legal Studies. Additionally, Spartak is a graduate of Humber College in Canada, where he earned certifications
                      as both a Paralegal and an Immigration Consultant.
                      With his extensive knowledge, legal expertise, and commitment to excellence, Spartak Gabroshvili offers comprehensive and tailored
                      immigration services to clients, navigating them through complex legal frameworks to achieve their goals
                    </p>
